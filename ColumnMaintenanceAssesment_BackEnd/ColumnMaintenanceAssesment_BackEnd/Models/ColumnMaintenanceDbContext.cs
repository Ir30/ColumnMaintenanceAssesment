...
public partial class ColumnMaintenanceDbContext : DbContext
{
    public ColumnMaintenanceDbContext()
    {
    }

    public ColumnMaintenanceDbContext(DbContextOptions<ColumnMaintenanceDbContext> options)
        : base(options)
    {
    }
